                ...
                <nav id="topbar" role="navigation" style="margin-bottom: 0; position: fixed;" data-step="3" class="navbar navbar-default navbar-static-top">
                    ...
                    <div class="topbar-main"><a id="menu-toggle" href="#" class="hidden-xs"><i class="fa fa-bars"></i></a>
                        <form id="topbar-search" action="search" method="" class="hidden-sm hidden-xs" style="width:28%;">
                            <div class="input-icon right text-white"><a href="#" onclick="document.getElementById('topbar-search').submit();"><i class="fa fa-search"></i></a><input id="tags"  type="text" placeholder="Search here..." class="form-control text-white" name="searchtext" required/></div>
                        </form>
